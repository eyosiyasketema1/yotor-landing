...
5. **Focus More on Ministry** banner
   - Full-width photo card with overlay heading and yellow CTA button

6. **Bento — People, Resources and Oversight**
...
7. **CTA bar** — "Everything you asked for…" tagline + yellow Get Started button
...
10. **Reviews** — 4 testimonial cards
...
15. **Final CTA banner** — *"A better way to manage your church"*
    - Photo card with yellow "manage" accent + cyan "Yotor.church" button

## Bottom of page

16. **Footer** — two visual rows
...
**Total: 15 content sections** between the navigation header and the footer, plus the sticky `<header>` and the `<footer>` itself.
